...
from trajplan.config import build_bspline_optimizer_config  # noqa: E402
from trajplan.config import (build_linear_mpc_config,
...
def main() -> None:
    ...
    agent_process = CrazyflieAgentProcess(
        ...
        ema_alpha=0.3,
        takeoff_height=1.5,
        takeoff_duration=3.1,
        landing_height=0.04,
        landing_duration=3.1,
